...
const diceRoll = document.getElementById("diceAudio");
...
elComeOut.onclick   = function () {comeOutRoll(); diceRoll.play();};

elPointRoll.onclick = function () {pointRoll(); diceRoll.play();};
